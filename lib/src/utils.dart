...
class Utils {
  ...
  /// direction.
  static Vector2 Function(double angle) angleToVector = _defaultAngleToVector;

  /// Method to compute the orientation angle of a non-zero vector.
  ///
  /// This method must be the inverse of [angleToVector], modulo τ.
  static double Function(Vector2 vector) vectorToAngle = _defaultVectorToAngle;

  static Vector2 _defaultAngleToVector(double angle) {
    return Vector2(cos(angle), -sin(angle));
  }

  static double _defaultVectorToAngle(Vector2 vector) {
